          ...
          public void onClick(View v)
            {
                ...
                sqliteHelper.addProduct(new Product(null ,ProductName,Description,Category,Price,imageInByte));

                Intent intent = new Intent(AddProductActivity.this, ConsultingActivity.class);
